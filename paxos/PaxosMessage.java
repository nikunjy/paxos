...
class PingRequestMessage extends PaxosMessage {
	Command command;
	public PingRequestMessage(ProcessId src, Command command) { 
		this.src = src; 
		this.command = command;
	}
}
class PingReplyMessage extends PaxosMessage {
	Command command;
	public PingReplyMessage(ProcessId src, Command command) { 
		this.src = src; 
		this.command = command;
	}
}
